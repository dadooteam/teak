...
<%
  List<ArchivePO> imageArchives = (List<ArchivePO>)request.getAttribute("imageArchives");
  List<ArchivePO> latestArchives = (List<ArchivePO>)request.getAttribute("latestArchives");
  PagePO introductionPage = (PagePO)request.getAttribute("introductionPage");
